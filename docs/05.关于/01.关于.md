...
- **WeChat or QQ**: <a :href="qqUrl" class='qq'>1179601966</a>
- **Email**:  <a href="mailto:hedongshu@foxmail.com">hedongshu@foxmail.com</a>
...
<script>
  export default {
    data(){
      return {
        qqUrl: 'tencent://message/?uin=1179601966&Site=&Menu=yes' 
      }
    },
    mounted(){
      const flag =  navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i);
      if(flag){
        this.qqUrl = 'mqqwpa://im/chat?chat_type=wpa&uin=1179601966&version=1&src_type=web&web_src=oicqzone.com'
      }
    }
  }
</script>           